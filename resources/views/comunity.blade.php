...
@if($comunity['id'] <= '1')    
<img src="/assets/images/{{ $comunity['images'] }}" alt="" class="lg:mr-[10rem] md:w-[50%] lg:[70%] w-auto mx-auto md:mx-0">
@else
<img src="{{ asset('storage/'.$comunity['images'])}}" alt="" class="lg:mr-[10rem] md:w-[50%] lg:[70%] w-auto mx-auto md:mx-0">
                    @endif
<div class="content md:pt-0 pt-20">
        <h4 class="text-text">{{ $comunity['title'] }}</h4>
        <h2 class="text-[2.5rem] font-bold pb-4">{{ $comunity['subtitle'] }}</h2>
        <p class="text-[#dddddd] text-[.9rem] pb-5 md:w-[90%] w-auto">{!! $comunity['description'] !!}</p>
