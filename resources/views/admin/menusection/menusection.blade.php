                                    ...
                                    <tr class="tr-shadow">
                                        ...
                                        <td>
                                            <div class="table-data-feature">
                                                <a class="item" data-toggle="tooltip" data-placement="top" title="Edit" href="/dashboard/menusection/{{ $c['id'] }}/edit">
                                                    <i class="zmdi zmdi-edit"></i>
                                                </a>
                                                @if($c['id'] != '1')
                                                <form action="/dashboard/menusection/{{ $c['id'] }}" method="POST">
